---
layout: post
title: "Mental health and premenstrual/period symptoms in transgender women"
...
Note that there is no control group. I could [statistically analyze my journal]({% post_url 2025-10-14-journal-data-analysis %}) to formally test for a difference in frequency of mental illness-related words between the 14th and 21st of each month, relative to the other days of each month. Without a formal statistical comparison, it's possible that the above pattern can be better explained as follows: my mental health varies mostly randomly, and if you look for a pattern with a certain level of uncertainty (e.g., a fairly wide window of days), you are bound to find a pattern even where there is only random variation. This is similar to the statistical phenomenon of [alignment of random points](https://en.wikipedia.org/wiki/Alignments_of_random_points), which can explain the otherwise spooky tendency for [famous landmarks to be aligned in space](https://en.wikipedia.org/wiki/Ley_line).

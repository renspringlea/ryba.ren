...
1. Responsibility and accountability for high-stakes moral or financial decisions.
2. Deep, specific context (e.g. highly niche information, local cultural practices, subtle cues in a messy environment).
3. Black-swan creativity / paradigm shifts (e.g. Einstein's shift from classical physics to general relativity, moving fully outside of existing thought).
4. Authentic lived experience and a shared human experience (e.g. empathy, trust).
5. Doing things in the physical world.

...
# Driving distance    
The first thing to consider is driving distance. In a [previous blog post]({% post_url 2025-10-14-insects-driving %}), I concluded that if you drive for 1 km, you can expect to hit ~1.5 - 90 insects with your car, though there is significant variation around that estimate.    
...
In a [previous blog post]({% post_url 2025-09-13-artificial-turf %}), I began to explore whether there is a difference in the number of insects who live in grass versus artificial turf.    
...
- [45,447 insects were found from ~11 circles of ~3m diameter](https://core.ac.uk/download/pdf/77006429.pdf), indicating ~1,600 insects/m² in short rye grass in England (an underestimate due to the methdology) (Table 4.4, control group)    
- [Several thousand insects were found in the average ~112m² plot of experimentally managed grassland in the United States](https://academic.oup.com/ee/article-abstract/16/1/100/413457), indicating dozens or hundreds of insects/m², though it's hard to give an exact number due to the methodology    
- [~100 - 200 insects per 0.36 m² turf plot in England](https://link.springer.com/article/10.1007/s10531-014-0788-1), indicating ~420 insects/m² (though this was over multiple sampling periods?) (Figure 1A)    
- [An average of ~1,000 invertebrates recorded per domestic urban garden in England](https://www.researchgate.net/profile/Kenneth-Thompson-2/publication/227329556_Urban_domestic_gardens_VIII_Environmental_correlates_of_invertebrate_abundance/links/562d409408ae22b17034c0c7/Urban-domestic-gardens-VIII-Environmental-correlates-of-invertebrate-abundance.pdf), though the area sampled is unclear    
- [271 bees, wasps, and flower flies found in residential lawn in Canada](https://corpus.ulaval.ca/server/api/core/bitstreams/67a1fa86-7e59-4bce-927f-176fd965f826/content), though area is unclear (Table 2)    
- [~35 invertebrates in each sample of soil in urban tree habitat](https://www.researchgate.net/profile/Valentin-Schaefer-3/publication/276155388_Detecting_the_threshold_between_ornamental_landscapes_and_functional_ecological_communities_soil_microarthropods_as_indicator_species/links/568c5cb908ae153299b666ac/Detecting-the-threshold-between-ornamental-landscapes-and-functional-ecological-communities-soil-microarthropods-as-indicator-species.pdf), not really useful for us except for the finding that inteverbrate abundance was higher 1-2 cm deep in the soil than 0-1 cm deep.    
...
How many times do I step on the ground while playing soccer? Two internet users [here](https://www.quora.com/How-many-steps-might-someone-do-during-a-90-minute-football-match-I-know-it-will-vary-Just-wondering-if-anyone-ever-measured-theirs) indicate ~10,000 - 20,000 steps.    

Professional men's goalkeepers cover ~5 km in a match ([source](https://www.researchgate.net/figure/The-mean-distances-m-covered-by-goalkeepers-during-a-match-relative-to-the-different_tbl1_342570113)). I'm neither professional nor a man, but I do like to wander pretty far out of my penalty box to protect my team from through-balls—so let's call this 3 km. If my average stride is 80 cm, then this equates to ~3,800 steps per match. I'm ignoring the fact that I often fall into the ground (which means more area covered).    
...
Much of the discussion on this question is anecdotal. Adherents of the religion Jainism [avoid stepping on grass](https://voices.uchicago.edu/religionculture/2017/11/22/attending-to-insects/) precisely because they think that doing so crushes insects, as Jains usually practice non-violence (an attitude and lifestyle that I wholeheartedly endorse). There are also many online forums, often debating veganism, where forum users argue about whether or not stepping on grass kills bugs—there seems to be a general agreement that stepping on grass kills bugs *at least sometimes*, but as is often the case in online debates, empirical evidence is not forthcoming.    

Some relevant empirical sources are:    
- [Ciach et al 2017](https://www.researchgate.net/profile/Tadeusz-Wojas/publication/311153194_Watch_your_step_Insect_mortality_on_hiking_trails/links/5e72063b92851c93e0aa7d60/Watch-your-step-Insect-mortality-on-hiking-trails.pdf?_sg%5B0%5D=started_experiment_milestone&origin=journalDetail&_rtd=e30%3D) found lots of crushed invertebrates on hiking trails, indicating that stepping on bugs can directly kill them. The trails were "covered with a mixture of soil, rock or rock debris, and natural vegetation was present adjacent to the path" - so they're not grass trails, but there is grass on the side of the path.    
- [Ayres et al 2008](https://www.academia.edu/download/8057268/2008%20ayres%20et%20al%20cons%20biol.pdf) looked at invertebrates in Antarctica (obviously not representative for sports pitches!) and found that trampling increased the ratio of dead-to-living invertebrates. This doesn't rule out decreased breeding rather than increased deaths, as the authors point out.    
- Duffy ([1975](https://www.sciencedirect.com/science/article/abs/pii/0006320775900427)) showed that trampling on grassland litter (not the same thing as a sports pitch, but similar) causes a decline in the abundance of invertebrates. This is consistent with the hypothesis that trampling on grass directly kills invertebrates. However, it's also possible that the observed decline in abundance is due to other factors, such as less resource or space availability meaning that insects breed less, rather than being killed directly.    
- [This environmental impact assessment from a Scottish transport company](https://www.transport.gov.scot/media/2067/a1013-terrestrial-invertebrates.pdf) (?) addresses invertebrates: "Trampling by humans can also cause direct mortality [...]."    
